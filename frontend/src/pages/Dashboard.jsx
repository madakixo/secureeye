...
import { Camera, Plus, ShieldAlert, X } from 'lucide-react';
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {cameras.length === 0 && (
              <div className="col-span-full border-2 border-dashed border-gray-300 rounded-lg p-12 text-center text-gray-500">
                No cameras added yet. Click "Add Camera" to start monitoring.
              </div>
            )}
            {cameras.map(cam => (
        ...
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-xl font-bold">Add New Camera</h3>
            ...
            <form onSubmit={handleAddCamera} className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium mb-1">Stream URL / Path</label>
                <input
                  required
                  type="text"
